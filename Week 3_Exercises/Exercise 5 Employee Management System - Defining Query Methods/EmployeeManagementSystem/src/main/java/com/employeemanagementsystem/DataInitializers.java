...
public class DataInitializers implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("Found Employee by Email: \n" + employeeRepository.findByEmail("srk@example.com"));
        System.out.println("\nEmployees in IT Department: \n" + employeeRepository.findByDepartmentName("HR"));
        System.out.println("\nDepartment by Name: \n" + departmentRepository.findByName("IT"));    
    }
}
